...
name_zh: "动效中文名称"
cover_video: "../assets/[name字段的值].mp4" # 必须直接替换为 name 字段的实际值，例如 ../assets/donmolinico-intro-menu-hover.mp4
cdn_video_url: "https://pub-78bb53484bcd4179b692b8ebeee0e014.r2.dev/[name字段的值].mp4" # 必须直接替换为 name 字段的实际值
